from pit.utils.logger import setup_logger
from pit.datasets import make_dataloader
from pit.model import make_model
from pit.solver import make_optimizer
from pit.solver.scheduler_factory import create_scheduler
from pit.loss import make_loss
from pit.processor import do_train
import random
import torch
import numpy as np
import os
...
from pit.utils.saver import Saver
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="configs/iLIDS-VID/pit.yml", help="path to config file", type=str
    )
